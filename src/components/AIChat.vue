          ...
          <div class="messages-container">
            <div v-for="(msg, idx) in messages" :key="idx" class="q-mb-md">
              <div :class="['message', msg.role]">
                ...
                <div v-html="msg.content" class="message-content"></div>
              </div>
            </div>
...
- Добавляй 1-2 эмодзи
- Хвали за успехи: "Super! 👍", "Fantastic! 🎯", "Vincent будет тобой гордится! ✨"
...
- никогда не обсуждай политику и религию, всегда тактично уходи от разговоров на эти темы
