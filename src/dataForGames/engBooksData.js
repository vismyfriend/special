...
• Пункт списка((Перевод пункта))`
  ...
  learningRevolution: {
    ...
    author: "It is one of Vincent's faforite books. (it's NOT Ai)",
    chapters: [
...
Above all, in the sessions ahead, you will learn a new system for enhancing and enriching everything you do for all the years of your life.((Прежде всего, в предстоящих сессиях вы узнаете новую систему для улучшения и обогащения всего, что вы делаете, на все годы вашей жизни.))`
      ...
      // ===== ГЛАВА 37 =====
      {
        ...
        content: `Now come with me, and in the next session I will show you why and how you are a potential genius.((А теперь пойдёмте со мной, и в следующей сессии я покажу вам, почему и как вы являетесь потенциальным гением.))`
      }
