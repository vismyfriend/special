...
• Пункт списка((Перевод пункта))`
  ...
  acceleratedLearningInAction1: {
    ...
    chapters: [
      ...
      {
        title: null,
        content: `Welcome to the revolution.((Добро пожаловать в революцию.)) We entered into the most <em>turbulent /\u00A0тёр\u00A0бу\u00A0лент\u00A0/</em> time in all of human history. ((Мы вступили в самое неспокойное время во всей истории человечества)) Now, the changes happen more often, more <em><b>rapidly</b> /\u00A0рэ\u00A0пид\u00A0ли\u00A0/</em>, and more <em><b>unpredictably</b> /\u00A0ан\u00A0пре\u00A0дик\u00A0та\u00A0бли\u00A0/</em> than ever before. ((Сейчас перемены происходят чаще, быстрее и непредсказуемее, чем когда-либо прежде.))

And the only thing we know about the future is that it will be faster, more changing, and more unpredictable than the present.((И единственное, что мы знаем о будущем — оно будет быстрее, изменчивее и непредсказуемее, чем настоящее.)) Your job is to learn how to <em>survive</em> and <em><b>thrive</b></em> in the months and years ahead. ((Ваша задача — научиться выживать и процветать в предстоящие месяцы и годы))

And this Special book is designed to help you do exactly that.((И эта особенная программа создана, чтобы помочь вам именно в этом.))`
      },
      {
        title: null,
        content: `The Key Principle is : ((Ключевой момент, принцип :))

<strong>The great breakthrough in your life</strong> ((Самый великий прорыв в вашей жизни)) <strong>comes when you realize</strong> ((наступает, когда вы осознаёте)) <strong> - you can learn anything you need to learn</strong>((вы можете выучить все что требуется выучить))<strong>, to accomplish any goal that you can set for yourself.((вы можете научиться всему, чему вам нужно научиться, чтобы достичь любой цели, которую вы перед собой ставите.))</strong>`
      },
      {
        title: "This is the story of Brian Tracy ((Это история Брайана Трэйси))",

        content: `I have studied, practiced, and taught / тот / in the <i> area of human potential development</i> for more than 30 years.((Я изучал, практиковал и преподавал в области развития человеческого потенциала более 30 лет.))
...
"Why are some people <b>more successful / сак сэс фул /</b> than others?"((«Почему так? Почему одни люди более успешны, чем другие?»))

"Why is it that some people make more money?" ((Почему так - почему некоторые люди зарабатывают больше денег?))

"Why is it that some people have nicer homes and cars?" ((Почему так - почему некотоые имеют более красивые дома и машины?))

"Why do they enjoy better lives and relationships?" ((Почему они наслаждаются лучшей жизнью и отношениями?))

And why do they have better health and seem to get far more satisfaction out of life? ((И почему они имеют лучшее здоровье и, кажется, получают гораздо больше удовлетворения от жизни?))
...
And at the same time, why is it that the great majority are frustrated and unhappy with their current levels of achievement?((И в то же время, почему подавляющее большинство разочарованы и недовольны своим текущим уровнем достижений?)) Why is it that so few people realize their full potentials for living?((Почему так мало людей реализуют свой полный жизненный потенциал?))`
      },
      {
        ...
        content: `If you look for something - you will find it. ((Если вы что-то ищите, то вы найдете это))

Even The Bible says it:((Даже в Библии сказано про это:)) "Seek and you shall find, for all who seek find it."((«Ищите и найдете, ибо всякий ищущий находит.»))
...
<b>If you could find out</b> ((если сможете выяснить)) <b>what the most successful people did in any area, and then you did the same thing over and over,</b> ((что делали самые успешные люди в любой области, и затем делали бы то же самое снова и снова, ))<b>you would </b> /вуд ивЭнчули/ <strong> eventually get the same results as they do.</strong>(( вы бы в итоге получили те же результаты, что и они.))
...
I used this strategy while being at a junior position in sales: ((Будучи на начальной позиции в продажах я использовал эту стратегию)) This discovery did change my life.((Это открытие действительно изменило мою жизнь.)) I was stuck in sales without progress for a year.((Я топтался на месте в продажах в течение года.)) When I looked and learned what top-managers were doing, I immediately began:((Когда я посмотрел и изучил, что топ-менеджеры делали, я немедленно начал:))
...
<b>This means that there are no limits on what you can be, have, or do.</b> ((Это означает, что нет никаких ограничений на то, кем вы можете быть, что иметь и что делать.))

All you have to do is: ((Всё, что вам нужно сделать, это:))
...
It may take you a week or a month or a year, but your success is inevitable / инЭви тэбл / using this simple approach. ((Это может занять неделю, месяц или год, но ваш успех неизбежен при использовании этого простого подхода.))`
      },
      {
        ...
        -- Choose one of the goals that you mentioned and answer: "What do I need to learn to achieve my goal?"
        `,
      },
    ]
  },
  ...
  acceleratedLearningInAction3: {
    ...
    chapters: [
      ...
      // ===== ГЛАВА 38 =====
      {
        ...
        content: `You are a <b><em>potential</b> /\u00A0потЭн\u00A0шиал\u00A0/</em> <b>genius</b><em>/\u00A0джи\u00A0ни\u00A0ус\u00A0/</em>.((Ты — потенциальный гений.)) You have the <b><em>mental capacity</em></b> to be, have and do anything you really want in life.((У тебя есть умственный потенциал-емкость, чтобы быть, иметь и делать всё, что ты действительно хочешь в жизни.)) By <b><em>harnessing</em></b> your amazing mental powers you can <b><em>accomplish</em></b> any goal, <em>overcome</em> any obstacle and <b><em>solve</em></b> any problem.((Обуздав свои удивительные умственные силы, ты можешь достичь любой цели, преодолеть любое препятствие и решить любую проблему.))

We are learning more today about the <b><em>incredible</b> /\u00A0ин\u00A0крЭ\u00A0дэ\u00A0бэл/ potential</em>  of your brain, than we ever learned before in human history.((Сегодня мы узнаём об невероятном потенциале твоего мозга больше, чем когда-либо прежде за всю историю человечества.)) And all of it is good.((И всё из этого — хорошие новости.))

The <b><em>bottom line</em></b> of the research, that is now <b><em>pouring in</b>/\u00A0пОрин\u00A0ин\u00A0/</em> from all sides, is that you have amazing powers that you have not yet begun to use.((Суть исследований, которые сейчас поступают со всех сторон, заключается в том, что у вас есть удивительные способности, которые вы еще не начали использовать.)) When you learn to use your brain power to its full <em>potential</em>, the things you will be able to <em>accomplish</em> will be far beyond anything you've ever done in the past.((Когда вы научитесь использовать силу своего мозга на полную мощность, то, чего вы сможете достичь, будет далеко за пределами всего, что вы делали в прошлом.))
...
You become a genius by learning how to use all of your intelligences in the areas of your life that are important to you.((Вы становитесь гением, научившись использовать все свои виды интеллекта в важных для вас сферах жизни.)) People today are learning math through songs, chants, and jingles.((Сегодня люди изучают математику через песни, напевы и рекламные джинглы.)) They are learning by physically handling counters, by actually picturing the patterns that numbers make, or by working together in pairs through imagery, through colored charts and diagrams.((Они учатся, физически манипулируя счетными палочками, фактически представляя себе паттерны, которые образуют числа, или работая вместе в парах с помощью образов, цветных диаграмм и схем.)) and they are loving it.((и им это нравится.)) People are learning to write really creatively by using learning maps, which you will hear about later.((Люди учатся писать действительно креативно, используя интеллект-карты, о которых вы узнаете позже.)) They are making vivid mental pictures before they start writing.((Они создают яркие мысленные образы перед тем, как начать писать.)) They are acting parts of their stories, and they are seeing the value of working in pairs.((Они разыгрывают части своих историй и видят ценность работы в парах.)) In the sessions ahead, you will learn how to unlock more and more of your intelligences to ensure that you learn how to learn in ways that suit your unique mix of capabilities.((В следующих занятиях вы узнаете, как раскрывать все больше и больше своих видов интеллекта, чтобы гарантировать, что вы научитесь учиться способами, подходящими вашему уникальному сочетанию способностей.))`
  ...
  acceleratedLearningInAction3: {
    mainTitleOfTheText: "Six Stages of Learning",
    author: "(это не ИИ) -> this is one of Vincent's favorite books. Часть третья.",
    // audioUrl: new URL('../assets/audio/02-YouAreAGenius.mp3', import.meta.url).href,
    ...
    chapters: [
      // ===== ГЛАВА 1 =====
      {
        title: "Accelerated Learning Techniques ((Техники ускоренного обучения))",
        content: `Accelerated Learning Techniques is a complete learning-to-learn program.((Техники ускоренного обучения — это полная программа по обучению тому, как учиться.)) It shows you in detail how to tackle any learning task confidently and successfully.((Она показывает вам детально, как справляться с любой учебной задачей уверенно и успешно.)) Because the tools of learning are universal, this system works as well for adult learners as for students.((Поскольку инструменты обучения универсальны, эта система работает одинаково хорошо как для взрослых учащихся, так и для студентов.)) It will make life easier for anyone who is ever faced with a training session, a classroom, a lecture, a textbook, or a business course.((Она облегчит жизнь любому, кто сталкивается с тренингом, классом, лекцией, учебником или бизнес-курсом.))

Perhaps the most important single recommendation I can give you about this course is that you must practice what you learn continually until it becomes automatic.((Возможно, самая важная рекомендация, которую я могу дать вам об этом курсе, — вы должны постоянно практиковать то, что выучили, пока это не станет автоматическим.)) It's absolutely amazing how many people take extremely good courses in speed reading, memory, selling, management, and a variety of other subjects, but then fail to practice what they've learned often enough until it becomes second nature.((Удивительно, как много людей проходят отличные курсы по скорочтению, памяти, продажам, управлению и другим предметам, но затем не практикуют выученное достаточно часто, чтобы это стало второй натурой.)) As a result, they lose most of what they've learned and sometimes end up with only a happy memory of how much better things could have been if they had committed the new ideas and methods to heart.((В результате они теряют большую часть выученного и иногда остаются лишь с приятным воспоминанием о том, насколько лучше всё могло бы быть, если бы они приняли новые идеи и методы близко к сердцу.))

I've studied success for many years and in many areas.((Я изучал успех много лет и во многих областях.)) After failing to graduate from high school and laboring at odd jobs around the country and around the world, I finally got into sales and then into management and then into a variety of other businesses.((После того как я не смог окончить школу и работал на случайных работах по стране и миру, я наконец попал в продажи, затем в управление, а затем в различные другие бизнесы.)) In my 30s, I took an executive MBA program at the university and spent perhaps 3,000 hours learning the intricacies of modern management.((В свои 30 лет я поступил на программу MBA для руководителей в университете и потратил, возможно, 3000 часов на изучение тонкостей современного управления.)) Over the years, I read hundreds, perhaps thousands of books and articles on success and achievement in a variety of fields.((За годы я прочитал сотни, возможно тысячи, книг и статей об успехе и достижениях в различных областях.))`
      },

      // ===== ГЛАВА 2 =====
      {
        title: "The Success System ((Система успеха))",
        content: `One of the most important things I learned is that you need a success system to achieve anything worthwhile.((Одна из самых важных вещей, которые я узнал, — вам нужна система успеха, чтобы достичь чего-то стоящего.)) You cannot do it in a random, haphazard way.((Вы не можете делать это случайным, беспорядочным образом.)) The primary reason that people fail to achieve their full potential is because they're operating by gosh and by golly.((Основная причина, по которой люди не достигают своего полного потенциала, — они действуют наугад.)) They're making it up as they go along.((Они импровизируют на ходу.)) They're attempting to wing it, and they end up accomplishing very little.((Они пытаются действовать без подготовки и в итоге достигают очень малого.))

One of the great secrets of success is to study the experts.((Один из главных секретов успеха — изучать экспертов.)) Find out what other successful people have done and do the same thing over and over until you get the same results.((Узнайте, что делали другие успешные люди, и делайте то же самое снова и снова, пока не получите те же результаты.)) And any success system is better than no success system at all.((И любая система успеха лучше, чем отсутствие системы успеха вообще.))

The turning point in my life came when I sat down in my small one-bedroom apartment with my rented furniture, deeply in debt with everything I owned around me in boxes and hanging in the cupboard.((Поворотный момент в моей жизни наступил, когда я сидел в своей маленькой однокомнатной квартире с мебелью напрокат, глубоко в долгах, со всеми моими вещами в коробках и висящими в шкафу.)) I decided at that time to quit fooling myself and to develop a blueprint for success that I would then discipline myself to follow.((В тот момент я решил перестать обманывать себя и разработать план успеха, которому я затем дисциплинированно буду следовать.)) In the next year, I accomplished more than I had accomplished in the previous five years.((В следующем году я достиг большего, чем за предыдущие пять лет.)) In five more years, I had gone from being uneducated, unskilled, untrained, and unemployed to being the chief operating officer of a $275 million company.((Ещё через пять лет я прошёл путь от необразованного, неквалифицированного, необученного и безработного до главного операционного директора компании стоимостью 275 миллионов долларов.))`
      },

      // ===== ГЛАВА 3 =====
      {
        title: "The Six Stages of Learning ((Шесть стадий обучения))",
        content: `In this session, you're going to learn a system that I wish I had had many years ago.((В этой сессии вы узнаете систему, которую я бы хотел иметь много лет назад.)) It would have saved me hundreds of hours of study and hard work and maybe months and years of spinning my wheels trying to figure it out for myself.((Она сэкономила бы мне сотни часов учёбы и тяжёлой работы и, возможно, месяцы и годы бесплодных попыток разобраться во всём самостоятельно.)) This six-step system is simple and elegant and will be explained in detail in subsequent sessions.((Эта шестиступенчатая система проста и элегантна и будет подробно объяснена в следующих сессиях.)) Once you've learned it, memorized it, and practiced it over and over until it becomes a natural part of your learning behaviors, you'll find yourself advancing faster and further than you ever had before.((Как только вы выучите её, запомните и будете практиковать снова и снова, пока она не станет естественной частью вашего учебного поведения, вы обнаружите, что продвигаетесь быстрее и дальше, чем когда-либо прежде.))

Effective learning involves six definite stages.((Эффективное обучение включает шесть чётких стадий.)) I'll explain them briefly now and then go into them in greater depth in subsequent sessions.((Я кратко объясню их сейчас, а затем углублюсь в них в следующих сессиях.))

Number one is your state of mind.((Первая — ваше состояние ума.)) You need to be in what is called a resourceful state of mind.((Вам нужно быть в так называемом ресурсном состоянии ума.)) This is a state of mind that is relaxed, confident, and motivated.((Это состояние ума, которое расслаблено, уверенно и мотивированно.)) If you're under stress or if you lack confidence in your ability to learn, or you cannot see the point of what you're learning, you won't learn well.((Если вы находитесь в стрессе, или вам не хватает уверенности в вашей способности учиться, или вы не видите смысла в том, что изучаете, вы не будете учиться хорошо.))`
      },

      // ===== ГЛАВА 4 =====
      {
        title: "Stage One: Getting into the Right State of Mind ((Стадия первая: Вхождение в правильное состояние ума))",
        content: `Getting into the right state of mind is similar to getting physically and mentally prepared for playing a competitive sport.((Вхождение в правильное состояние ума похоже на физическую и ментальную подготовку к соревновательному виду спорта.)) The better you do it in advance, the better you will play when you get onto the field.((Чем лучше вы подготовитесь заранее, тем лучше вы сыграете, когда выйдете на поле.))

In stage one, getting into the resourceful state of mind, the first question you need to ask is, what's in it for me?((На первой стадии, входе в ресурсное состояние ума, первый вопрос, который вам нужно задать: что мне это даст?)) The more motivated you are to learn, the faster you will take in new information.((Чем более мотивированы вы учиться, тем быстрее вы будете усваивать новую информацию.)) The more intense your desire for the new knowledge and the more relevant that knowledge is to what you are doing at present, the easier it will be for you to learn.((Чем сильнее ваше желание новых знаний и чем более релевантны эти знания тому, что вы делаете в настоящем, тем легче вам будет учиться.))

And you can set up or prepare your mind in such a way that you are eager to absorb the new information.((И вы можете настроить или подготовить свой ум таким образом, чтобы быть готовым впитывать новую информацию.)) Here's some good questions for you.((Вот несколько хороших вопросов для вас.)) What are the advantages to you of improving your ability to learn?((Каковы преимущества для вас в улучшении вашей способности учиться?)) What is the payoff for you?((Какова для вас выгода?)) How will it improve your life for you to become a rapid learner in your work and in other subjects that interest you?((Как это улучшит вашу жизнь, если вы станете быстро учиться в своей работе и в других предметах, которые вас интересуют?))

You see, learning is a set of skills.((Видите ли, обучение — это набор навыков.)) Once you acquire those skills, you will find yourself working smarter, not harder.((Как только вы приобретёте эти навыки, вы обнаружите, что работаете умнее, а не усерднее.))`
      },

      // ===== ГЛАВА 5 =====
      {
        title: "Benefits of Rapid Learning ((Преимущества быстрого обучения))",
        content: `Here's some of the key benefits that others feel that learning to learn rapidly can offer them.((Вот некоторые из ключевых преимуществ, которые, как считают другие, может дать им умение быстро учиться.))

First, learning helps in every job and career.((Во-первых, обучение помогает в любой работе и карьере.)) Every advance forward in your work will come as a result of learning and applying something new and different.((Каждый шаг вперёд в вашей работе будет результатом изучения и применения чего-то нового и другого.)) The more and faster you learn, the more rapidly you advance.((Чем больше и быстрее вы учитесь, тем быстрее вы продвигаетесь.))

Second, knowledge and skills can become obsolete with changes in information and technology, but learning how to learn is something that you can have for life.((Во-вторых, знания и навыки могут устаревать с изменениями в информации и технологиях, но умение учиться — это то, что вы можете иметь на всю жизнь.)) When you become skillful at the process of learning, you can continually improve every part of your life.((Когда вы становитесь искусным в процессе обучения, вы можете постоянно улучшать каждую часть своей жизни.))

Third, good learners earn more money for two reasons.((В-третьих, хорошие ученики зарабатывают больше денег по двум причинам.)) First, they can tackle many different jobs, and they can usually get more done in less time.((Во-первых, они могут справляться со многими разными работами и обычно успевают сделать больше за меньшее время.)) Because they're more flexible and more productive, they can justify higher pay by giving greater value to their employers.((Поскольку они более гибкие и более продуктивные, они могут оправдать более высокую оплату, давая большую ценность своим работодателям.))

Fourth, learning how to learn effectively is an important skill to pass on to children and partners.((В-четвёртых, умение эффективно учиться — это важный навык, который стоит передать детям и партнёрам.)) Your whole family benefits.((От этого выигрывает вся ваша семья.)) Teaching your children how to become excellent learners can do more to assure their lifelong success than perhaps anything else they can get from you.((Обучение ваших детей тому, как стать отличными учениками, может сделать больше для обеспечения их пожизненного успеха, чем, возможно, всё остальное, что они могут получить от вас.))

Fifth, training and retraining is an ongoing fact of life.((В-пятых, обучение и переобучение — это постоянный факт жизни.)) This will increasingly demand the ability to master textbooks and training sessions, and it'll never end.((Это будет всё больше требовать способности осваивать учебники и тренинги, и это никогда не закончится.))`
      },

      // ===== ГЛАВА 6 =====
      {
        title: "Relaxation and Visualization ((Расслабление и визуализация))",
        content: `Getting yourself properly motivated by thinking of how you will benefit from learning new subjects is the starting point of creating the right state of mind.((Правильно мотивировать себя, думая о том, как вы выиграете от изучения новых предметов, — это отправная точка создания правильного состояния ума.))

The second part of creating a resourceful mental state is for you to relax and visualize a successful outcome to the learning experience.((Вторая часть создания ресурсного ментального состояния — это расслабиться и визуализировать успешный результат учебного опыта.)) When you're tense, your brain doesn't work well.((Когда вы напряжены, ваш мозг работает плохо.)) In fact, in some cases, tension or fear can literally make your mind go blank.((Фактически, в некоторых случаях напряжение или страх могут буквально вызвать у вас пустоту в голове.)) So before you turn your mind to anything, take a few deep breaths and consciously let your jaw and neck muscles go slack.((Поэтому прежде чем направить своё внимание на что-либо, сделайте несколько глубоких вдохов и сознательно расслабьте мышцы челюсти и шеи.)) Breathe from your lower stomach rather than from your upper chest.((Дышите нижней частью живота, а не верхней грудью.)) Take a couple of deep breaths and just rotate your head and neck before you begin again.((Сделайте пару глубоких вдохов и просто повращайте головой и шеей, прежде чем начать снова.)) You'll notice the difference immediately.((Вы заметите разницу сразу.))

Now, having calmed yourself, spend a few moments to create a really clear vision of what it will be like to succeed at what you are learning.((Теперь, успокоившись, потратьте несколько минут, чтобы создать действительно чёткое видение того, как это будет — преуспеть в том, что вы изучаете.)) See yourself confidently tackling new learning tasks.((Представьте себя уверенно справляющимся с новыми учебными задачами.)) Feel a sense of pride in knowing that you can master the subject.((Почувствуйте гордость от осознания того, что вы можете освоить предмет.)) Hear the sort of approving comments people will make when they recognize your new level of mastery.((Услышьте одобрительные комментарии людей, когда они узнают о вашем новом уровне мастерства.))`
      },

      // ===== ГЛАВА 7 =====
      {
        title: "Stage Two: Intake of New Information ((Стадия вторая: Восприятие новой информации))",
        content: `The second stage of learning is the intake of new information.((Вторая стадия обучения — восприятие новой информации.)) You need to take in the facts to suit your particular learning preferences.((Вам нужно воспринимать факты в соответствии с вашими предпочтениями в обучении.)) There are differences in the extent to which you need to see, hear, or get physically involved in what you're learning.((Существуют различия в том, насколько вам нужно видеть, слышать или физически участвовать в том, что вы изучаете.))

When you first start to read or listen to something new, you need to do something to make that information more memorable to yourself.((Когда вы только начинаете читать или слушать что-то новое, вам нужно сделать что-то, чтобы сделать эту информацию более запоминающейся для себя.)) What you will do depends on your preference for visual, auditory, or physical learning, or whether a deliberate combination of all three works best for you.((То, что вы будете делать, зависит от вашего предпочтения визуального, аудиального или физического обучения, или от того, работает ли для вас лучше всего осознанная комбинация всех трёх.))

Here's a simple exercise to illustrate the importance of learning to learn in your preferred style using your dominant intelligence.((Вот простое упражнение, чтобы проиллюстрировать важность обучения в вашем предпочтительном стиле с использованием вашего доминирующего интеллекта.)) Take a sheet of paper and sign your name.((Возьмите лист бумаги и подпишите своё имя.)) Then, below that on the same sheet of paper, sign your name again with your other hand.((Затем ниже на том же листе подпишите своё имя снова другой рукой.)) Stop the tape and do this now.((Остановите запись и сделайте это сейчас.))

What did you think and feel as you signed with your non-preferred hand?((Что вы думали и чувствовали, когда подписывали не предпочитаемой рукой?)) You probably found that the task was rather awkward.((Вы, вероятно, обнаружили, что задача была довольно неловкой.)) It probably took longer and required more effort and concentration.((Это, вероятно, заняло больше времени и потребовало больше усилий и концентрации.)) In addition, the result was not as good.((Кроме того, результат был не таким хорошим.)) Your signature was not as smooth or as attractive.((Ваша подпись была не такой плавной или привлекательной.))`
      },

      // ===== ГЛАВА 8 =====
      {
        title: "Discovering Your Learning Style ((Обнаружение вашего стиля обучения))",
        content: `When you learn how to learn in your preferred style, the way that best suits your individual brain, it will be like writing with your preferred hand.((Когда вы научитесь учиться в своём предпочтительном стиле — способе, который лучше всего подходит вашему индивидуальному мозгу, — это будет как писать предпочитаемой рукой.)) The results will be much better, easier, and quicker.((Результаты будут намного лучше, легче и быстрее.)) This program will show you how to discover and use your preferred way of learning.((Эта программа покажет вам, как обнаружить и использовать свой предпочтительный способ обучения.)) As a result, it promises not only to accelerate your learning, but to make it easier, more effective, and above all, more enjoyable.((В результате она обещает не только ускорить ваше обучение, но и сделать его более лёгким, эффективным и, прежде всего, более приятным.))

What you do to take in information better depends upon which of your senses help you to learn best.((То, что вы делаете для лучшего восприятия информации, зависит от того, какие из ваших чувств помогают вам учиться лучше всего.)) People are different in the way they like to use their various senses as they learn.((Люди различаются по тому, как они любят использовать свои различные чувства при обучении.)) In other words, some people prefer large amounts of visual material.((Другими словами, некоторые люди предпочитают большое количество визуального материала.)) Some people like to listen as they learn, and many need a fair amount of physical involvement to learn well.((Некоторые любят слушать, когда учатся, а многим нужно значительное физическое вовлечение, чтобы учиться хорошо.))

I know a couple, for example, who are very successful in their professions.((Я знаю одну пару, например, которая очень успешна в своей профессии.)) She learns visually by reading and writing.((Она учится визуально через чтение и письмо.)) He learns in an auditory way by listening to people talk and to audio cassettes.((Он учится аудиальным способом, слушая, как говорят люди, и аудиокассеты.)) On a regular basis, they take time to sit down together and to explain to each other what they have learned using their different modalities.((На регулярной основе они находят время, чтобы сесть вместе и объяснить друг другу, что они узнали, используя свои разные модальности.)) In this way, together, they go through an enormous amount of new information.((Таким образом, вместе они проходят через огромное количество новой информации.))`
      },

      // ===== ГЛАВА 9 =====
      {
        title: "Combining Learning Modalities ((Комбинирование модальностей обучения))",
        content: `Most people learn best with a deliberate combination of visual, auditory, and kinesthetic.((Большинство людей учатся лучше всего при осознанном сочетании визуального, аудиального и кинестетического.)) If they can see it, hear it, and do it, they learn extremely well.((Если они могут это увидеть, услышать и сделать, они учатся чрезвычайно хорошо.))

Once you have an overall idea of what it is you are learning, make some brief notes for yourself.((Как только у вас появится общее представление о том, что вы изучаете, сделайте для себя краткие заметки.)) When you write, you activate your visual, auditory, and kinesthetic senses simultaneously.((Когда вы пишете, вы активируете свои визуальные, аудиальные и кинестетические чувства одновременно.)) You see what you are writing, you sub-vocalize or say the words to yourself, and you physically move your hand in forming the words on paper.((Вы видите, что пишете, вы проговариваете или произносите слова про себя, и вы физически двигаете рукой, формируя слова на бумаге.))

Write down what you already know about the subject.((Запишите, что вы уже знаете о предмете.)) Write out the most important principles that you're familiar with.((Выпишите наиболее важные принципы, с которыми вы знакомы.)) Jot down what looks new and worth paying attention to from what you've seen in your brief overview.((Запишите то, что выглядит новым и заслуживающим внимания из того, что вы увидели в своём кратком обзоре.)) Also, jot down what you need to find out more about.((Также запишите, что вам нужно узнать подробнее.))

Why should you do this?((Почему вы должны это делать?)) Because you rarely start with zero knowledge.((Потому что вы редко начинаете с нулевым знанием.)) If you give some thought to your general knowledge and experience, it's not only a great starting point, but it builds self-confidence for additional material.((Если вы немного подумаете о своих общих знаниях и опыте, это не только отличная отправная точка, но и укрепляет уверенность в себе для дополнительного материала.))`
      },

      // ===== ГЛАВА 10 =====
      {
        title: "The Power of Questions ((Сила вопросов))",
        content: `Making a few brief notes about the subject before you begin highlights important gaps in your knowledge and gets you into an alert state of mind.((Сделав несколько кратких заметок о предмете перед началом, вы выделяете важные пробелы в своих знаниях и входите в состояние настороженности.)) Your brain likes novelty and stimulation, and it's therefore set up to look for what is new to you in the coming material.((Ваш мозг любит новизну и стимуляцию, и поэтому он настроен искать то, что ново для вас в предстоящем материале.)) Writing a few notes about what you already know helps you to start making up questions.((Запись нескольких заметок о том, что вы уже знаете, помогает вам начать формулировать вопросы.)) Forming questions and looking for the answers to your own questions as you learn is a vital way to keep yourself interested in the process.((Формулирование вопросов и поиск ответов на ваши собственные вопросы в процессе обучения — это жизненно важный способ поддерживать интерес к процессу.))

All knowledge is just the answer to a question.((Все знания — это просто ответ на вопрос.)) Knowledge in and of itself is inert and has no value.((Знание само по себе инертно и не имеет ценности.)) It is only when you ask a question that the knowledge comes to life.((Только когда вы задаёте вопрос, знание оживает.))

Remember Rudyard Kipling's little poem, I keep six honest serving men.((Помните маленькое стихотворение Редьярда Киплинга: "Я держу шесть честных слуг".)) They taught me all I knew.((Они научили меня всему, что я знаю.)) Their names are what and why and when, and how and where and who.((Их имена: что и почему и когда, и как и где и кто.))

Some good questions for you to ask in approaching any subject might be, how can I use this information to improve my work or life?((Некоторые хорошие вопросы, которые вы можете задать, подходя к любому предмету: как я могу использовать эту информацию, чтобы улучшить свою работу или жизнь?)) How can I put this into my own words?((Как я могу перефразировать это своими словами?)) Paraphrasing new material is a powerful way to learn it more rapidly.((Перефразирование нового материала — это мощный способ выучить его быстрее.)) What is the writer or speaker trying to tell me?((Что пытается сказать мне писатель или оратор?)) What is his main idea or position?((Какова его главная мысль или позиция?)) Why is this true?((Почему это правда?)) If it's not true, what parts of it are false?((Если это не правда, какие её части ложны?)) How does this new information relate to what I already know?((Как эта новая информация соотносится с тем, что я уже знаю?)) Is it consistent with or contradictory with my existing knowledge and experience?((Согласуется ли это или противоречит моим существующим знаниям и опыту?))`
      },

      // ===== ГЛАВА 11 =====
      {
        title: "Active Learning Strategies ((Активные стратегии обучения))",
        content: `Simply reading a book or listening to a talk by itself is never enough.((Просто чтение книги или прослушивание выступления само по себе никогда не достаточно.)) It's too passive.((Это слишком пассивно.)) Your mind has a tendency to wander and you stop paying attention.((У вашего ума есть тенденция отвлекаться, и вы перестаёте обращать внимание.)) You need to do something extra in order to remember other people's words and to make them really mean something personal to you.((Вам нужно сделать что-то дополнительное, чтобы запомнить чужие слова и сделать их действительно лично значимыми для вас.)) You should always be doing something extra while you are listening, reading, or watching to make sure that more of your learning modalities are being activated and that you are internalizing more of the information.((Вы всегда должны делать что-то дополнительное, пока слушаете, читаете или смотрите, чтобы быть уверенным, что активируется больше ваших модальностей обучения и вы усваиваете больше информации.))

So, if you're a visual learner, stop and draw a diagram, a chart, or a picture of what you're learning.((Итак, если вы визуальный ученик, остановитесь и нарисуйте диаграмму, схему или картинку того, что вы изучаете.)) If you're reading, underline or highlight the new points.((Если вы читаете, подчеркните или выделите новые пункты.)) As a visual learner, you should stop occasionally and take the time to create a mental picture of what you're learning.((Как визуальный ученик, вы должны периодически останавливаться и находить время, чтобы создать мысленный образ того, что вы изучаете.)) Visualize the subject to yourself so that you can see it in your mind's eye.((Визуализируйте предмет для себя, чтобы вы могли увидеть его мысленным взором.))

If you're an auditory learner, you can increase the speed at which you learn by reading important sections or ideas out loud.((Если вы аудиальный ученик, вы можете увеличить скорость обучения, читая важные разделы или идеи вслух.)) Anything that you read out loud has almost double the impact on your brain as something that you simply read to yourself, because now you have not only seen it, but you have heard it as well.((Всё, что вы читаете вслух, оказывает почти вдвое большее влияние на ваш мозг, чем то, что вы просто читаете про себя, потому что теперь вы это не только увидели, но и услышали.)) As an auditory learner, you can increase the speed at which you learn by explaining what you have just learned to someone else.((Как аудиальный ученик, вы можете увеличить скорость обучения, объясняя то, что вы только что выучили, кому-то другому.))`
      },

      // ===== ГЛАВА 12 =====
      {
        title: "Physical Learning and Breaking Down Material ((Физическое обучение и разбивка материала))",
        content: `If you're a physical learner, make notes on index cards and then arrange the cards in a sequence that make sense to you.((Если вы физический ученик, делайте заметки на карточках, а затем расположите карточки в последовательности, которая имеет смысл для вас.)) You are then using your hands to rearrange your thoughts.((Затем вы используете свои руки, чтобы перестроить свои мысли.)) Also as a physical learner, you should feel free to move around as you learn.((Также как физический ученик, вы должны чувствовать свободу двигаться во время обучения.)) If you try out all these techniques, you will begin to find the ones that really help.((Если вы попробуете все эти техники, вы начнёте находить те, которые действительно помогают.)) Your main job is to experiment and find out the ways that you are most comfortable using to increase the speed and enjoyment of the learning process.((Ваша главная задача — экспериментировать и находить способы, которые вам наиболее комфортны для увеличения скорости и удовольствия от процесса обучения.))

The next part of getting the information to suit yourself is to break it down into small steps.((Следующая часть адаптации информации под себя — разбить её на небольшие шаги.)) Tackling a new subject can sometimes be overwhelming.((Освоение нового предмета иногда может быть ошеломляющим.)) Many learners fail, not because they lack the ability to learn, but because they become discouraged with the size of the apparent difficulty of what they're attempting.((Многие ученики терпят неудачу не потому, что им не хватает способности учиться, а потому что они падают духом перед очевидной сложностью и объёмом того, что они пытаются освоить.)) You deal with this by deliberately breaking down what you're trying to learn into small, easily mastered bits.((Вы справляетесь с этим, сознательно разбивая то, что пытаетесь выучить, на небольшие, легко усваиваемые части.)) By approaching your learning one step at a time, and by experiencing a number of small successes, your motivation and confidence increases and drives you forward.((Подходя к обучению шаг за шагом и переживая множество маленьких успехов, ваша мотивация и уверенность растут и двигают вас вперёд.))`
      },

      // ===== ГЛАВА 13 =====
      {
        title: "One Step at a Time Strategy ((Стратегия шаг за шагом))",
        content: `For example, you might start on something as simple as reading the chapter headings of a textbook you have to read.((Например, вы можете начать с чего-то такого простого, как чтение заголовков глав учебника, который вам нужно прочитать.)) Or, you might start on a single section that really interests you and master that.((Или вы можете начать с одного раздела, который вас действительно интересует, и освоить его.)) Or you could proceed one page at a time.((Или вы можете продвигаться по одной странице за раз.)) Stop at the end of each page to put a check mark to show that you really understand what you've read.((Останавливайтесь в конце каждой страницы, чтобы поставить галочку, показывающую, что вы действительно поняли прочитанное.))

A good example of this strategy of taking one small step at a time is learning the vocabulary for a foreign language.((Хороший пример этой стратегии — делать по одному маленькому шагу за раз — это изучение лексики иностранного языка.)) Anyone can learn ten new words a day of a new language.((Любой может выучить десять новых слов в день на новом языке.)) Yet, if you did this over the course of a year, you would have learned more than 3,000 words, which is the basis of an entire language.((Однако, если бы вы делали это в течение года, вы бы выучили более 3000 слов, что является основой целого языка.)) This was the learning plan that I stumbled into and taught myself many years ago.((Это был план обучения, на который я наткнулся и которому научил себя много лет назад.))

Many of us would like to be more educated and more refined.((Многие из нас хотели бы быть более образованными и более утончёнными.)) Perhaps we didn't get university educations, or perhaps we didn't study as hard as we could have.((Возможно, мы не получили университетского образования, или, возможно, мы не учились так усердно, как могли бы.)) Well, using this one-step-at-a-time approach, you can become one of the best educated people in our society in three years.((Что ж, используя этот подход — шаг за шагом, — вы можете стать одним из самых образованных людей в нашем обществе за три года.)) The method is simple.((Метод прост.)) Each evening, in the final hour before you go to bed, turn off the television, and instead read one essay, one poem, and one short story.((Каждый вечер, в последний час перед сном, выключите телевизор и вместо этого прочитайте одно эссе, одно стихотворение и один рассказ.)) Read them slowly and carefully, underlining key ideas, and make notes in the margin.((Читайте их медленно и внимательно, подчёркивая ключевые идеи, и делайте заметки на полях.)) Then take a few minutes afterwards to think about the important points in what you have read.((Затем уделите несколько минут, чтобы подумать о важных моментах в прочитанном.)) Over the course of three years, you will have read more than 1,000 essays, poems, and short stories.((За три года вы прочитаете более 1000 эссе, стихотворений и рассказов.)) You will have accomplished the equivalent of a graduate of literature from one of the finest universities in the country.((Вы достигнете уровня выпускника литературного факультета одного из лучших университетов страны.))`
      },

      // ===== ГЛАВА 14 =====
      {
        title: "Stage Three: Explore the Subject ((Стадия третья: Исследование предмета))",
        content: `The third stage of effective learning is to explore the subject.((Третья стадия эффективного обучения — исследовать предмет.)) You need to explore what you are learning.((Вам нужно исследовать то, что вы изучаете.)) You need to play with it.((Вам нужно играть с этим.)) Like a seashell on the beach, you need to pick it up and turn it over and look at it and in it to fully comprehend it.((Как морская ракушка на пляже, вы должны поднять её, перевернуть, посмотреть на неё и внутрь неё, чтобы полностью понять её.)) There's a difference between knowing about something and truly understanding it.((Есть разница между знанием о чём-то и истинным пониманием этого.)) When you thoroughly explore a subject, you turn surface knowledge into deep understanding.((Когда вы тщательно исследуете предмет, вы превращаете поверхностное знание в глубокое понимание.))

How you achieve this deeper understanding depends on other important learning preferences, preferences that depend on the unique way that you use your range of intelligences.((То, как вы достигаете этого более глубокого понимания, зависит от других важных предпочтений в обучении — предпочтений, которые зависят от уникального способа, которым вы используете свой спектр интеллектов.)) Unfortunately, we've all had the experience of something going in one ear and out the other.((К сожалению, у всех у нас был опыт, когда что-то влетает в одно ухо и вылетает в другое.)) That's because getting the basic facts is only the starting point of learning.((Это потому, что получение основных фактов — это только отправная точка обучения.)) You can compare learning with a plant.((Вы можете сравнить обучение с растением.)) When you first go over the subject, your knowledge is like a seedling, clinging precariously to the surface of the ground.((Когда вы только проходите предмет, ваше знание похоже на саженец, который неустойчиво держится на поверхности земли.)) Unless that seedling becomes a fully flowering plant with strong, deep roots, it's all too easy for it to wither away.((Если этот саженец не станет полностью цветущим растением с сильными, глубокими корнями, он слишком легко может засохнуть.)) So to convert surface knowledge to deep learning, you have to do something to make it take root.((Итак, чтобы превратить поверхностное знание в глубокое обучение, вы должны сделать что-то, чтобы оно пустило корни.))`
      },

      // ===== ГЛАВА 15 =====
      {
        title: "Seven Ways to Explore a Subject ((Семь способов исследовать предмет))",
        content: `Once you've got the basic facts, you have to stop and explore the subject.((Как только вы получили основные факты, вы должны остановиться и исследовать предмет.)) You have to play with the new information.((Вы должны играть с новой информацией.)) This is where you can begin to use the full range of your seven different intelligences.((Здесь вы можете начать использовать весь спектр ваших семи различных интеллектов.)) When the way in which your brain naturally likes to learn matches the way which you feed it new information, you will achieve fast, easy, stress-free learning.((Когда способ, которым ваш мозг естественно любит учиться, совпадает со способом, которым вы подаёте ему новую информацию, вы достигнете быстрого, лёгкого, свободного от стресса обучения.))

Here, then, are seven ways for you to explore a new subject in depth.((Итак, вот семь способов для вас глубже исследовать новый предмет.))

First, put it into your own words.((Первое: перефразируйте своими словами.)) Other people's words are never as memorable as your own, and it is only when you can express an idea fluently in your own words that you know that you've really understood it.((Чужие слова никогда не так запоминаются, как свои собственные, и только когда вы можете бегло выразить идею своими словами, вы знаете, что действительно поняли её.))

Two, create a learning map about it.((Второе: создайте карту обучения об этом.)) This is a highly effective, memorable, and concise form of notes.((Это очень эффективная, запоминающаяся и лаконичная форма заметок.)) We'll go into the steps in the creation of learning maps in greater depth later.((Мы подробнее рассмотрим шаги по созданию карт обучения позже.))

Third, discuss the new subject with someone else.((Третье: обсудите новый предмет с кем-то ещё.)) When you have to explain or defend a new subject to someone else, it clears your mind wondrously.((Когда вам приходится объяснять или защищать новый предмет перед кем-то ещё, это чудесным образом проясняет ваш ум.)) And besides, learning with others is usually more enjoyable.((И кроме того, учиться с другими обычно приятнее.)) Their questions and insights on the subject help you to think better about what it is you are learning.((Их вопросы и идеи по предмету помогают вам лучше думать о том, что вы изучаете.))`
      },

      // ===== ГЛАВА 16 =====
      {
        title: "More Ways to Explore a Subject ((Ещё способы исследовать предмет))",
        content: `Fourth, to explore the subject more fully, list out the main points in a logical order of importance.((Четвёртое: чтобы более полно исследовать предмет, выпишите основные пункты в логическом порядке важности.)) When you have to decide the most important points about a subject and how they relate to each other, it forces you to think more deeply about it.((Когда вам нужно определить самые важные пункты о предмете и то, как они соотносятся друг с другом, это заставляет вас думать о нём более глубоко.))

Fifth, explore the subject in a way that is physical.((Пятое: исследуйте предмет физическим способом.)) Sometimes you can make a simple model to understand a subject better or even act it out.((Иногда вы можете сделать простую модель, чтобы лучше понять предмет, или даже разыграть его по ролям.)) For other subjects, it may be more appropriate to write brief notes on cards and then put them into a sequence that feels right.((Для других предметов может быть более уместным написать краткие заметки на карточках, а затем расположить их в последовательности, которая кажется правильной.)) It's a way to sort out your thoughts physically.((Это способ физически упорядочить свои мысли.)) You could even make a card for each of these tools or steps of the learning process.((Вы даже можете сделать карточку для каждого из этих инструментов или шагов процесса обучения.))

Sixth, decide how the subject fits in to what you already know.((Шестое: определите, как предмет вписывается в то, что вы уже знаете.)) By relating and comparing what is new to things you already know, you build on existing knowledge.((Соотнося и сравнивая новое с тем, что вы уже знаете, вы надстраиваете существующие знания.)) It helps you to make sense of the subject.((Это помогает вам осмыслить предмет.))

And seven, write a song, jingle, or rap to summarize what you are learning.((И седьмое: напишите песню, джингл или рэп, чтобы обобщить то, что вы изучаете.)) You already know the words to dozens of songs without consciously trying to learn them.((Вы уже знаете слова дюжин песен, не прилагая сознательных усилий к их заучиванию.)) You may take the key points of a subject and create a rhyme or song that summarizes them so that you can remember them easily in the future.((Вы можете взять ключевые пункты предмета и создать рифму или песню, которая обобщает их, чтобы вы могли легко запомнить их в будущем.)) These are all different ways for you to play with the material and learn it faster.((Это всё разные способы для вас играть с материалом и учить его быстрее.))`
      },

      // ===== ГЛАВА 17 =====
      {
        title: "Stage Four: Memorize the Key Facts ((Стадия четвёртая: Запоминание ключевых фактов))",
        content: `The fourth stage of learning is for you to memorize the key facts.((Четвёртая стадия обучения — запомнить ключевые факты.)) If you have conscientiously practiced the first three stages, you can be sure that you have begun learning very efficiently already.((Если вы добросовестно практиковали первые три стадии, вы можете быть уверены, что уже начали учиться очень эффективно.)) It always helps, however, to lock it all down by making an attempt to memorize the key points.((Тем не менее, всегда помогает закрепить всё это, попытавшись запомнить ключевые пункты.)) Later, when you recall these key points, they will trigger your memory for the whole subject.((Позже, когда вы вспомните эти ключевые пункты, они запустят вашу память на весь предмет.)) These key points can be in the form, again, of a learning map, or a list, or on flashcards, or in some other way.((Эти ключевые пункты могут быть снова в виде карты обучения, списка, флеш-карточек или каким-либо другим способом.))

Research and follow-up testing indicates that, on average, you remember perhaps 20% of what you read.((Исследования и последующие тесты показывают, что в среднем вы запоминаете, возможно, 20% прочитанного.)) You remember 30% of what you hear.((Вы запоминаете 30% услышанного.)) You remember 40% of what you see.((Вы запоминаете 40% увиденного.)) You remember 50% of what you say.((Вы запоминаете 50% сказанного.)) You remember 60% of what you do.((Вы запоминаете 60% сделанного.)) And you remember 90% of what you see, hear, say, and do.((И вы запоминаете 90% того, что вы видите, слышите, говорите и делаете.))

To really memorize your notes, here's an idea.((Чтобы действительно запомнить ваши заметки, вот идея.)) Read them over and then look away and recreate the notes again from memory.((Прочитайте их, затем отведите взгляд и воссоздайте заметки снова по памяти.)) Initially, this is quite difficult, but it becomes easier with practice.((Сначала это довольно сложно, но становится легче с практикой.)) When you compare the original notes with the ones you've just made, you will soon see any gaps in your knowledge.((Когда вы сравните оригинальные заметки с теми, которые вы только что сделали, вы скоро увидите любые пробелы в ваших знаниях.)) Do this once or twice more and you can be certain that it will all be stored away permanently in your memory.((Сделайте это ещё один или два раза, и вы можете быть уверены, что всё это навсегда сохранится в вашей памяти.))`
      },

      // ===== ГЛАВА 18 =====
      {
        title: "The Power of Review and Taking Breaks ((Сила повторения и перерывов))",
        content: `Reviewing your notes is an extremely powerful way to learn effectively.((Повторение ваших заметок — чрезвычайно мощный способ эффективного обучения.)) It's been proven that when you look over your notes for just a few moments after one hour, after one day, after one week, and after one month, your likelihood of remembering the subject is increased 400%.((Доказано, что когда вы просматриваете свои заметки всего несколько мгновений через час, через день, через неделю и через месяц, ваша вероятность запомнить предмет увеличивается на 400%.))

An important part of accelerated learning is for you to take regular breaks.((Важная часть ускоренного обучения — делать регулярные перерывы.)) Most people's attention span is quite short.((У большинства людей концентрация внимания довольно короткая.)) After about 30 minutes, your attention begins to flag.((Примерно через 30 минут ваше внимание начинает ослабевать.)) Don't resent it, though.((Не обижайтесь на это, однако.)) Make a virtue of it.((Сделайте из этого добродетель.)) Research shows that we remember more of what occurs at the beginning and end of a learning session than at any other time.((Исследования показывают, что мы запоминаем больше из того, что происходит в начале и в конце учебной сессии, чем в любое другое время.)) One long learning session obviously has only one beginning and one end.((Одна длинная учебная сессия, очевидно, имеет только одно начало и один конец.)) But if you divide the session up into, say, four separate smaller sessions of half an hour each, you have eight beginnings and eight endings.((Но если вы разделите сессию на, скажем, четыре отдельные меньшие сессии по полчаса каждая, у вас будет восемь начал и восемь концов.)) So your overall concentration and learning is increased.((Таким образом, ваша общая концентрация и обучение увеличиваются.)) If you start each new half-hour session with a brief review of what you've just learned, you will begin to really maximize your learning.((Если вы начнёте каждую новую получасовую сессию с краткого повторения того, что вы только что выучили, вы начнёте действительно максимизировать своё обучение.))`
      },

      // ===== ГЛАВА 19 =====
      {
        title: "Stage Five: Show You Know ((Стадия пятая: Покажите, что вы знаете))",
        content: `The fifth stage of effective learning is to show you know what you have learned.((Пятая стадия эффективного обучения — показать, что вы знаете то, что выучили.)) You need to demonstrate to yourself and to others that you've actually got the critical parts of the information.((Вам нужно продемонстрировать себе и другим, что вы действительно усвоили критические части информации.)) Unless you test your understanding of what you've learned, you can't be sure that you've really understood it.((Если вы не проверите своё понимание того, что выучили, вы не можете быть уверены, что действительно поняли это.)) There's little point in learning something unless you can use that knowledge or skill and understand what you have learned.((Мало смысла учить что-то, если вы не можете использовать это знание или навык и понимать то, что выучили.)) So, as you near the end of your learning task, you should first test yourself to check if you have really understood it.((Итак, приближаясь к концу вашей учебной задачи, вы должны сначала проверить себя, чтобы убедиться, что действительно поняли её.))

See if you can remember the key points on your flashcards, your notes, or your learning map and what they mean.((Посмотрите, можете ли вы вспомнить ключевые пункты на ваших флеш-карточках, заметках или карте обучения и что они означают.)) Or, see how well you can explain the subject to someone else.((Или посмотрите, как хорошо вы можете объяснить предмет кому-то ещё.)) Paraphrase what you've learned in your own words, as if you were already teaching it to someone else who was very interested in knowing about it.((Перефразируйте то, что вы выучили, своими словами, как если бы вы уже преподавали это кому-то, кто очень заинтересован в этом.))

Second, practice what you've learned in a real-life situation.((Второе: практикуйте то, что вы выучили, в реальной жизненной ситуации.)) Actually, try out your new knowledge.((Фактически, попробуйте применить ваши новые знания.)) Go over the sequence several times in your head using mental rehearsal.((Прокрутите последовательность несколько раз в голове, используя мысленную репетицию.)) Remember, the sooner you actually practice new knowledge, the more likely it is that you will retain the information permanently.((Помните: чем скорее вы начнёте применять новые знания на практике, тем вероятнее, что вы сохраните информацию навсегда.))`
      },

      // ===== ГЛАВА 20 =====
      {
        title: "Stage Six: Reflect on How You Learn ((Стадия шестая: Рефлексия о том, как вы учитесь))",
        content: `The sixth and final stage of effective learning is reflecting on how you actually learn.((Шестая и последняя стадия эффективного обучения — рефлексия о том, как вы на самом деле учитесь.)) You need to think about how well the learning went.((Вам нужно подумать о том, насколько хорошо прошло обучение.)) The aim of this is to improve not just what you know, but how you learn.((Цель этого — улучшить не только то, что вы знаете, но и то, как вы учитесь.)) That way you become a better and better learner.((Таким образом, вы становитесь всё лучшим и лучшим учеником.)) It's been said that feedback is the breakfast of champions.((Говорят, что обратная связь — это завтрак чемпионов.)) When you structure your learning experiences and then give yourself organized feedback, you become better and better at learning subsequent materials.((Когда вы структурируете свой учебный опыт, а затем даёте себе организованную обратную связь, вы становитесь всё лучше и лучше в изучении последующих материалов.))

One of the highest skills you possess is the ability to stop and think about how things have gone, to give yourself feedback, and to work out how to improve them in the future.((Один из ваших высших навыков — это способность остановиться и подумать о том, как всё прошло, дать себе обратную связь и выработать способы улучшения в будущем.)) In this way, stumbling blocks can be converted to stepping stones to success.((Таким образом, препятствия могут быть превращены в ступеньки к успеху.)) You come to see errors as helpful pointers to future progress.((Вы начинаете видеть ошибки как полезные указатели к будущему прогрессу.))

The final stage in your learning plan, therefore, is to stop every now and then and ask two simple questions.((Таким образом, последняя стадия в вашем плане обучения — останавливаться время от времени и задавать два простых вопроса.)) First, how is the learning going?((Первый: как проходит обучение?)) And second, how could it have gone better?((И второй: как оно могло бы пройти лучше?)) These questions force you to think continually of the strong points of what you are doing and how you can improve them during future learning experiences.((Эти вопросы заставляют вас постоянно думать о сильных сторонах того, что вы делаете, и о том, как вы можете улучшить их в будущем учебном опыте.)) This helps you to drop ideas that don't work and to try new ones.((Это помогает вам отбросить идеи, которые не работают, и пробовать новые.))`
      },

      // ===== ГЛАВА 21 =====
      {
        title: "Personalizing Your Learning System ((Персонализация вашей системы обучения))",
        content: `Asking these questions helps you to personalize the way you use these learning steps in order to suit your own individual learning style.((Задавание этих вопросов помогает вам персонализировать способ использования этих учебных шагов, чтобы они соответствовали вашему индивидуальному стилю обучения.)) Eventually, learning becomes a way of taking in information that is ideal for your own brain.((В конечном итоге обучение становится способом восприятия информации, который идеален для вашего собственного мозга.)) Think of your true potential like a combination lock.((Представьте ваш истинный потенциал как кодовый замок.)) It's the unique combination of how you'd like to use your senses and seven intelligences that accounts for your own natural and individual approach to learning.((Это уникальная комбинация того, как вы хотите использовать свои чувства и семь интеллектов, которая определяет ваш собственный естественный и индивидуальный подход к обучению.)) When you understand how your brain works and when you develop a customized way of learning that matches your unique brain, the combination lock to your learning potential springs open.((Когда вы понимаете, как работает ваш мозг, и когда вы разрабатываете персонализированный способ обучения, соответствующий вашему уникальному мозгу, кодовый замок к вашему учебному потенциалу открывается.))

Let me repeat the six stages of learning.((Позвольте мне повторить шесть стадий обучения.))

First, get yourself into the right state of mind.((Первая: войдите в правильное состояние ума.)) You will learn a whole series of different ways to prepare yourself for maximum absorption of new information in the coming session.((Вы изучите целый ряд различных способов подготовки к максимальному усвоению новой информации в предстоящей сессии.))

Second, take in the new information in a variety of ways that are consistent with how you prefer to learn.((Вторая: воспринимайте новую информацию различными способами, согласующимися с вашими предпочтениями в обучении.))

Third, explore the information from a variety of different angles using your different intelligences until you make it your own.((Третья: исследуйте информацию с разных точек зрения, используя ваши различные интеллекты, пока вы не сделаете её своей.))

Fourth, memorize the information using the memory techniques that you will learn on subsequent tapes.((Четвёртая: запомните информацию, используя техники запоминания, которые вы выучите на следующих записях.))

Fifth, show you know and demonstrate your new knowledge in a variety of ways to make sure that you really have it.((Пятая: покажите, что вы знаете, и продемонстрируйте ваши новые знания различными способами, чтобы убедиться, что вы действительно ими обладаете.))

And sixth, review and reflect on the process of learning, looking for ways for you to do it better and more efficiently next time.((И шестая: обзорывайте и рефлексируйте над процессом обучения, ища способы сделать это лучше и эффективнее в следующий раз.))`
      },

      // ===== ГЛАВА 22 =====
      {
        title: "The Story of an Elephant ((История о слоне))",
        content: `Let me finish this session with a brief story.((Позвольте мне закончить эту сессию краткой историей.)) This is also true.((Это тоже правда.)) I saw it in my travels in India many years ago.((Я видел это во время своих путешествий по Индии много лет назад.))

When elephant <b><em>trainers</b> /\u00A0трЭй\u00A0нэз\u00A0/</em> in India catch a baby elephant, they tie one of its legs to a post with a rope.((Когда дрессировщики слонов в Индии ловят слонёнка, они привязывают одну из его ног к столбу верёвкой.)) The baby elephant <b><em>struggles</b> /\u00A0стрА\u00A0глз\u00A0/</em> and <em>struggles</em>, but it can't get free.((Слонёнок борется и борется, но не может освободиться.)) For days, the baby elephant <b><em>pulls</em></b> and <b><em>strains</b> /\u00A0стрЭйнз\u00A0/</em> at the rope.((В течение нескольких дней слонёнок тянет и напрягает верёвку.)) <b><em>Gradually</b> /\u00A0грА\u00A0джу\u00A0э\u00A0ли\u00A0/</em>, however, it learns that struggle is <b><em>useless</b> /\u00A0йЮс\u00A0лэс\u00A0/</em>, and <b><em>eventually</b> /\u00A0и\u00A0вЭн\u00A0чу\u00A0э\u00A0ли\u00A0/</em> it gives up.((Однако постепенно он понимает, что борьба бесполезна, и в конце концов сдаётся.))

When the elephant grows up, the <em>trainer</em> keeps it tied to the same rope in the same way.((Когда слон вырастает, дрессировщик продолжает привязывать его той же верёвкой тем же способом.)) And even though it could now easily break the rope and get away, it stands <b><em>passively</b> /\u00A0пА\u00A0сив\u00A0ли\u00A0/</em> and waits for the trainer to come and get it.((И хотя теперь он мог бы легко порвать верёвку и убежать, он стоит пассивно и ждёт, когда дрессировщик придёт и заберёт его.)) It has developed what is called <b><em>learned helplessness</b> /\u00A0лё\u00A0нд хЭлп\u00A0лэс\u00A0нэс\u00A0/</em>.((У него развилось то, что называется выученной беспомощностью.)) It has learned that the struggle is useless.((Он узнал, что борьба бесполезна.)) As the result of repeated <b><em>failure</b> /\u00A0фЭй\u00A0ль\u00A0э\u00A0/</em> experiences early in life, the elephant has learned a <b><em>self-imposed limitation</b> /\u00A0сэлф\u00A0им\u00A0пО\u00A0зд л\u00A0им\u00A0и\u00A0тЭй\u00A0шн\u00A0/</em>.((В результате повторных неудач в раннем возрасте слон усвоил самоналоженное ограничение.))

Now, there's not one of us who is totally free from the <b><em>trap</b> /\u00A0трЭп\u00A0/</em> of <em>learned helplessness</em>.((Сейчас нет ни одного из нас, кто был бы полностью свободен от ловушки выученной беспомощности.)) We let our past experiences <b><em>limit</b> /\u00A0лИ\u00A0мит\u00A0/</em> our future.((Мы позволяем нашему прошлому опыту ограничивать наше будущее.)) Yet the truth is that there are no real <b><em>limits</b> /\u00A0лИ\u00A0митс\u00A0/</em> on what you can learn when you have a <b><em>systematic</b> /\u00A0сис\u00A0тэ\u00A0мА\u00A0тик\u00A0/</em> plan of action and you understand how you learn best.((Но правда в том, что нет реальных ограничений на то, что вы можете выучить, когда у вас есть систематический план действий и вы понимаете, как вы учитесь лучше всего.))

In the coming sessions, you will discover your most <b><em>efficient</b> /\u00A0и\u00A0фИ\u00A0шнт\u00A0/</em> learning style and develop a proven plan of action to <b><em>tackle</b> /\u00A0тА\u00A0кл\u00A0/</em> any learning task, however <b><em>complex</b> /\u00A0кОм\u00A0плэкс\u00A0/</em> it may seem at first.((В следующих сессиях вы откроете для себя свой самый эффективный стиль обучения и разработаете проверенный план действий для решения любой учебной задачи, какой бы сложной она ни казалась на первый взгляд.)) And the more you learn, the more you'll be able to learn.((И чем больше вы учитесь, тем больше вы сможете учиться.)) Soon you'll be performing at levels of <b><em>accomplishment</b> /\u00A0э\u00A0кОм\u00A0пл\u00A0иш\u00A0мэнт\u00A0/</em> that you never imagined possible.((Скоро вы будете работать на уровнях достижений, которые вы никогда не считали возможными.))`
      }
    ]
  },
  jokes: {
...
The candidate says: "I don't give a f#@k what you think." ((Кандидат говорит: "Мне плевать, что вы думаете."))`,
      ...
      // ===== ШУТКА ПРО БАНК =====
      {
        ...
        content: `Today was my first day of work at the bank. ((Сегодня был мой первый рабочий день в банке))

        And an old lady asked me to check her balance... ((Одна пожилая женщина попросила меня проверить её баланс...))

        So I pushed her! ((Так что я её толкнул.))

        She fell on the floor, ((Она упала на пол))

        She had ZERO balance! ((У нее баланс на нуле))

        I don't understand why everybody was shouting at me... ((Не понимаю почему на меня все орали!))`
...
You mustn't fart, because they don't have windows. ((Нельзя пукать, потому что у них нет окон. - Игра слов: "Windows" - это и "окна", и операционная система Windows - конкурент Apple))`
  ...
  readAndDraw: {
    mainTitleOfTheText: "Read and draw",
    ...
    chapters: [
      // ===== ВВЕДЕНИЕ =====
      {
        content: `Эта книга настраивает на правильное произношение английских звуков.
Чтобы вы могли звучать красиво и быть <b>понятным</b> и <b>приятным</b> собеседником тренируйте произношение.

Произнесите вслух уверенно и быстро: <b>[\u00A0рид\u00A0эн\u00A0дро\u00A0]</b> переводится: Читайте\u00A0и\u00A0рисуйте. Read and draw. <i>(заметили, что в произношении ДВА звука Д, а не три)</i>

--

Дальше в книге можно нажимать на английский текст, чтобы увидеть перевод и проверить себя, правильно ли вы догадались как переводится данное предложение. Читайте целиком предложение вслух на английском, затем пробуйте перевести целиком предложение, не по словам отдельным, а смысл предложения передавайте. А после можно кликнуть и сравнить перевод.
`
      },
      {
        title: "Beginning / бе гИ нин / ((Начало. Ударение на второй слог))",
        content: `<b>/ ит из э стори эбАУт уАн фЭмили /</b>

<b>It is a story about one family. </b>(( Это история про одну семью ))

The family name is Special. / спэшл / (( Фамилия этой семьи "Особенные" ))

<b>7</b> persons / пЁр сонс / live in this family. (( 7 человек живет в этой семье  ))

We can draw / дро / all persons. ((Мы можем нарисовать всех персон - членов семьи.))

If we have a pen or a pencil. ((Если у нас есть ручка или карандаш.))

If we don't have a pen, we can't draw / дро /. ((Но если у нас нет ручки, мы не сможем нарисовать.))

Do you have a pen or a pencil ? ((У тебя есть ручка или карандаш?))
...
Вы закончили одну из первых английских книг! Ура ура ура!

<b>You are a super agent! /Эйджэнт/ ((вы супер агент))</b>

<i>На экзамене нужно будет прочитать без подсказок, без ошибок, без запинок про одного или двух из персонажей из спЭшд фЭмили, случайно выбранных училкой</i>`
      }
    ]
  },
...
Little Red Riding Hood promised to obey her mother. ((Красная Шапочка пообещала слушаться свою маму.))`
      ...
      // ===== ГЛАВА 4 =====
      {
        ...
        And with that he jumped out of bed, jumped on top of poor Little Red Riding Hood, and ate her as he ate her granny! ((И с этими словами он выпрыгнул из кровати, прыгнул на бедную Красную Шапочку и съел её как и ее бабулю.)) The wolf didn't even chew... ((Волк даже не пережевал))`
      },


      {
        title: "A hunter ((Охотник))",
        content: `As soon as the wolf ate them, he climbed back into bed, fell asleep, and began to snore very loudly. ((Как только волк закончил этот вкусный обед, он забрался обратно в кровать, заснул и начал очень громко храпеть.)) A hunter was just passing by. ((Охотник как раз проходил мимо.)) He thought it strange that the old woman was snoring so loudly, so he decided to take a look. ((Он подумал, что странно, что старушка так громко храпит, и решил заглянуть.)) He stepped inside, and in the bed there lay the wolf that he had been hunting for such a long time. ((Он вошёл внутрь, и в кровати лежал тот самый волк, на которого он так долго охотился.)) "He has eaten the grandmother, but perhaps she still can be saved. ((«Он съел бабушку, но, возможно, её ещё можно спасти.)) I won't shoot him," thought the hunter. ((«Я не буду в него стрелять,» — подумал охотник.)) So he took a pair of scissors and slowly, without making sounds, cut open his belly. ((Поэтому он взял ножницы и тихо, без звука, разрезал волку живот.)) He didn't kill the wolf, and he didn't wake him up! ((Он не убил волка и даже не разбудил его)) And inside wolf's belly he saw the red hat shining through. ((И внутри волчьего пуза он увидел как блестит красная шапочка.)) He cut a little more, and the girl jumped out and cried: ((Он разрезал ещё немного, и девочка выпрыгнула и закричала:)) "Oh, I was so frightened! ((«О, как же мне было страшно!)) It was so dark inside the wolf's body!" ((«Так темно было внутри волчьего тела!»)) And then the grandmother came out alive as well. ((А затем вышла живой и бабушка.)) Then Little Red Riding Hood took some large heavy stones from the street. ((Затем Красная Шапочка взяла большие тяжёлые камни с улицы.)) They filled the wolf's body with them, and stitched up the sleeping wolf ((они наполнили пузо волка камнями и зашили его аккуратно наложив швы на спящего волчару)) When he woke up, he tried to run away, the stones were so heavy that he fell down and died / дайд /. ((Когда он проснулся и попытался убежать, камни были такими тяжёлыми, что он упал замертво.))

People were happy. ((Все трое людей были счастливы.))

The hunter took the wolf's pelt. ((Охотник снял с волка шкуру.)) The grandmother ate the cake and drank the wine that Little Red Riding Hood had brought. ((Бабушка съела пирог и выпила вино, которое принесла Красная Шапочка.)) And Little Red Riding Hood thought to herself: ((И Красная Шапочка подумала про себя:))
...
- "As long as I live, I will never leave the path and run off into the woods by myself if mother tells me not to." ((«Пока я жива, я никогда не сойду с тропинки и не убегу в лес одна, если мама запретит мне.»))`
      ...
      // ===== ГЛАВА 6 =====
      {
        title: "The Lesson ((Урок))",
        content: `Another time, when Little Red Riding Hood went to granny and met another wolf in the forest, the wolf told her to leave the path. ((В другой раз Красная Шапочка снова встретила уже другого волка, который заговорил с ней и хотел, чтобы она сошла с тропинки.)) But Little Red Riding Hood didn't listen to the wolf and went straight to grandmother's. ((Но Красная Шапочка не стала слушать его и пошла прямо к бабушке.)) Everybody was happy, nobody was eaten. ((Все были счастливы и никого не был съеден))`
      }
    ]
  },
  test: {
