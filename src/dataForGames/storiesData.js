    ...
    listOfStories: [
      ...
      },
      {
        ...
        text: "Кейси и я _ (are) лучшие друзья! Casey _ (is) смешная маленькая кошка. Она _ (-) обожает гоняться за комарами и мухами. Каждый день она _ (-) носится по дому, словно она _ (is) супергерой!\n" +
          ...
          "\n" +
          "Потом хитрая муха _ (is) на окне. Муха _ (is) быстрая. Все мухи _ (are) быстрые и каждый день мухи _ (-) дразнят Кейси! Мой котёнок _ (-) подкрадывается тихо... но муха _ (is) умная! Она _ (-) улетает от котяры, и Кейси _ (is) в шоке.\n" +
          "\n" +
          ...
          "\n" +
          "Комары и мухи _ (are) её любимые «игрушки». И я _ (am) уверен, завтра она _ (is) готова снова охотиться на летающих жучков и паучков и разных мошек! Это _ (is) конец истории. История _ (-) завершается после точки. It is the end of the story.",
