...
const shortWordsData = {
  ...
  ImOnlyHumanSong: [
    { eng: "foolish", ru: "глупый" },
    { eng: "blind", ru: "слепой" },
    { eng: "see through", ru: "видеть насквозь, видеть истинную суть" },
    { eng: "behind", ru: "позади, за" },
    { eng: "no way to prove it", ru: "невозможно это доказать" },
    { eng: "I'm only human", ru: "Я всего лишь человек" },
    { eng: "after all", ru: "в конце концов, в конечном счете" },
    { eng: "Don't put your blame on me", ru: "Не взваливай свою вину на меня" },
    { eng: "Take a look", ru: "Взгляни" },
    { eng: "mirror", ru: "зеркало" },
    { eng: "are you deceived?", ru: "тебя обманули?" },
    { eng: "believe", ru: "верить" },
    { eng: "Be out of luck", ru: "не везёт, не повезло" },
    { eng: "solve problems", ru: "решать проблемы" },
    { eng: "Lord", ru: "Господь" },
    { eng: "heavens", ru: "небеса" },
    { eng: "above", ru: "над, выше" },
    { eng: "Don't ask my opinion", ru: "Не спрашивай моё мнение" },
    { eng: "don't ask me to lie", ru: "не проси меня лгать" },
    { eng: "Blame somebody", ru: "Винить кого-либо" },
    { eng: "I blame nobody", ru: "Я никого не виню" },
    { eng: "I don’t blame you", ru: "Я тебя не виню" },
    { eng: "Vincent puts blame on me", ru: "Винсент взваливает вину на меня" },
    { eng: "Only", ru: "Только, лишь" },
    { eng: "Are you blind?", ru: "Ты что, слепой?" },
    { eng: "Is she blind?", ru: "Она что, слепая?" }
  ],
