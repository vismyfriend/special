...
const MillionaireData = {
  ...
  a2test1: [
    {
      text: "Did Santa give you ___ nice presents?",
      options: {
        A: "some",
        B: "any",
        C: "anything",
    ...
    {
      text: "He ___ shares his secrets with anyone",
      options: {
        A: "never",
        B: "doesn't",
        C: "will",
    ...
    {
      text: "We have ___ patience for this situation",
      options: {
        A: "few",
        B: "little",
        C: "any",
    ...
    {
      text: "I've ___ finished my homework",
      options: {
        A: "yet",
        B: "still",
        C: "already"
    ...
    {
      text: "My brother ___ drive a car",
      options: {
        A: "can't",
        B: "can't to",
        C: "doesn't can to"
    ...
    {
      text: "Mathematics ___ difficult for me",
      options: {
        A: "are",
        B: "is",
        C: "-"
    ...
    {
      text: "I ___ my arm. I can't write now",
      options: {
        A: "have broken",
        B: "break",
        C: "breaked"
    ...
    {
      text: "My friends ___ started a business",
      options: {
        A: "has",
        B: "have",
        C: "did",
    ...
    {
      text: "I need to ___ the shopping",
      options: {
        A: "make",
        B: "have",
        C: "do"
    ...
    {
      text: "We ___ that movie last week",
      options: {
        A: "saw",
        B: "have seen",
        C: "are seeing"
    ...
    {
      text: "He decided to give up ___",
      options: {
        A: "to smoke",
        B: "smoke",
        C: "smoking"
    ...
    {
      text: "You have passed the exam, ___?",
      options: {
        A: "don't you",
        B: "have you",
        C: "haven't you",
    ...
    {
      text: "There ___ a cat and two dogs in the garden",
      options: {
        A: "are",
        B: "is",
        C: "some"
    ...
    {
      text: "Are you coming with us? – Yes, I ___",
      options: {
        A: "do",
        B: "was",
        C: "am",
    ...
    {
      text: "There's ___ milk in the fridge",
      options: {
        A: "a",
        B: "some",
        C: "any"
    ...
    {
      text: "They became friends when they ___ at university",
      options: {
        A: "are",
        B: "was",
        C: "were",
    ...
    {
      text: "We don't want ___ to know about this",
      options: {
        A: "he",
        B: "him",
        C: "that he"
    ...
    {
      text: "There ___ some apples on the tree yesterday",
      options: {
        A: "was",
        B: "were",
        C: "are",
    ...
    {
      text: "Will they join us? – No, they ___",
      options: {
        A: "won't",
        B: "wouldn't",
        C: "will"
    ...
    {
      text: "As soon as he ___, we'll start",
      options: {
        A: "arrive",
        B: "will arrive",
        C: "arrives"
    ...
    {
      text: "___ parents are very kind",
      options: {
        A: "they",
        B: "them",
        C: "their"
    ...
    {
      text: "Now he ___ chocolate ice cream",
      options: {
        A: "is loving",
        B: "loved",
        C: "loves",
    ...
    {
      text: "She's going ___ school now",
      options: {
        A: "at",
        B: "to",
        C: "-",
    ...
    {
      text: "The train ___ in 10 minutes",
      options: {
        A: "leaves",
        B: "will leaves",
        C: "is leaving",
    ...
    {
      text: "Who ___ the keys to the car?",
      options: {
        A: "have",
        B: "has"
      },
    ...
    {
      text: "If she ___ calls me tonight, I'll be happy",
      options: {
        A: "-",
        B: "will",
        C: "are",
  ...
  testA2EzF1: [
    ...
    {
      text: "Did you get ___ good books?",
      options: {
        A: "some",
        B: "any",
        C: "anything",
    ...
    {
      text: "She didn't drink ___ coffee.",
      options: {
        A: "few",
        B: "a few",
        C: "much",
    ...
    {
      text: "This is ___ best cake I've ever had!",
      options: {
        A: "a",
        B: "an",
        C: "the",
    ...
    {
      text: "We haven't finished the task ___.",
      options: {
        A: "yet",
        B: "ever",
        C: "already",
  ...
  a2test1repass1extra: [
    ...
    {
      text: "We have ___ love in this world",
      options: {
        A: "few",
        B: "little",
        C: "any",
    ...
    {
      text: "She ___ help me with anything",
      options: {
        A: "can't",
        B: "can't to",
        C: "doesn't can to"
    ...
    {
      text: "I ___ my leg. I can't go now",
      options: {
        A: "have hurt",
        B: "hurt",
        C: "hurted"
    ...
    {
      text: "Those people ___ organized a band",
      options: {
        A: "has",
        B: "have",
        C: "did",
    ...
    {
      text: "I want to ___ some gardening",
      options: {
        A: "make",
        B: "have",
        C: "do"
    ...
    {
      text: "She has stopped the train, ___?",
      options: {
        A: "doesn't she",
        B: "has she",
        C: "hasn't she",
    ...
    {
      text: "There ___ a door and 2 windows there",
      options: {
        A: "are",
        B: "is",
        C: "some"
    ...
    {
      text: "Are you going there? – Yes, I ___",
      options: {
        A: "do",
        B: "was",
        C: "am",
    ...
    {
      text: "There's ___ paper on the table",
      options: {
        A: "a",
        B: "some",
        C: "any"
    ...
    {
      text: "I don't want ___ to leave me",
      options: {
        A: "she",
        B: "her",
        C: "that she"
    ...
    {
      text: "How ___ sugar do you eat a day?",
      options: {
        A: "many",
        B: "much",
        C: "is"
    ...
    {
      text: "There ___ some grapes there the day before yesterday",
      options: {
        A: "was",
        B: "were",
        C: "are",
    ...
    {
      text: "As soon as she ___, I'll do it",
      options: {
        A: "come",
        B: "will come",
        C: "comes"
    ...
    {
      text: "___ children are too noisy",
      options: {
        A: "they",
        B: "them",
        C: "their"
    ...
    {
      text: "I'm going ___ home with you",
      options: {
        A: "at",
        B: "to",
        C: "-",
    ...
    {
      text: "Who ___ a shower with you?",
      options: {
        A: "have",
        B: "has"
      },
    ...
    {
      text: "If he ___ kisses me tomorrow, I'll kiss him",
      options: {
        A: "-",
        B: "will",
        C: "are",
    ...
    {
      text: "They will arrive ___ Sunday",
      options: {
        A: "in",
        B: "on",
        C: "at",
  ...
  introMillionaire22: [
    ...
    {
      text: "Что обычно мешает людям быстро выучить английский?",
      options: {
        A: "Лень",
        B: "Отсутствие практики",
        C: "Не делание домашки",
        D: "Отсутсвие мотивации",
        E: "Времени нет"
      },
      correctAnswer: "A",
    },
    {
      text: "Как по-английски произнести: 9 миллионов ?",
      options: {
        A: "/ найн мИллион /",
        B: "/ эйт мИллион /",
        C: "/ илЭвэн хАндред /",
    ...
    {
      text: "В неделе 168 часов - задумайся: сколько времени в неделю ты инвестируешь в свой навык английского?",
      options: {
        A: "меньше чем 3 часа в неделю",
        B: "больше чем 3 часа в неделю",
        C: "я не считаю сколько",
        D: "с учителем занимаюсь и ещё самостоятельно",
        E: "недостаточно",
        F: "Винсент!!! Хитрец - мудрец... Заставил задуматься",
        G: "достаточно"
      },
      correctAnswers: "F"
    },
